...
<html>
<head>
<link rel="stylesheet" type="text/css" href="simple.paint.css">
</head>
<body>
<!-- Boxen -->
...
<script type="text/javascript">
	...
	function aufanfang() {
		document.getElementById("svg").innerHTML=	'<line id="PinselX" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(200,200,200);stroke-width:2"></line>'
													+'<line id="PinselY" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(200,200,200);stroke-width:2"></line>';
													//ja toll weil innerhtml die pinsel löscht muss ich die hier neu anhaengen.
		LinieNr=0;
	}
...
<div id="funktionen">
	<svg id="funktionsKnoebbe"width=80 height=150>
		...
		<!-- Reset -->
		<rect x="00" y="25" rx="10" ry="23" width="42" height="15" style="fill:#ffffff;stroke-width:1;stroke:#000000;opacity:0.5" ></rect> 		
		<text x="04" y="36" font-family="Arial" font-size="12" fill="#000000" onclick="aufanfang()">reset</text>
